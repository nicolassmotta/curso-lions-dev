...
- Tema definido e sem repetição com outro grupo.
- Levantamento de requisitos preenchido.
...
O projeto final deve ser simples, funcional e demonstrável. Um sistema pequeno funcionando de ponta a ponta vale mais que uma ideia grande sem integração real.
