...
# Exercício: Biblioteca no Boilerplate (Meu Acervo e Meus Empréstimos)
...
No Módulo 08 você fez a API da Biblioteca Lions com dois recursos (Material e Empréstimo) no `server.js`. Agora ela vai para o boilerplate em camadas, com uma novidade: cada bibliotecário tem o próprio acervo. Materiais e empréstimos pertencem ao usuário logado.

> **Nível:** avançado. São dois recursos, um relacionamento por `ObjectId` e uma regra que cruza coleções. Faça os exercícios de Petshop e Academia antes.
...
## 3. Regras do Sistema (valem para os dois recursos)
...
3. **Toda consulta filtra pelo dono**, tanto em Material quanto em Empréstimo.
...
> ```
>
> O `salvar(doc)` faz só isso: `doc.save()`.
...
### 7.2 `EmprestimoService`: a parte principal do exercício
...
<div style="text-align: center; color: #6B7280; font-size: 13px; margin-top: 50px;">
  ...
  <i>Biblioteca no Boilerplate (Auth + camadas) - Módulo 09</i>
</div>
